...
<Library LVVersion="15008000">
	...
	<Item Name="System Explorer" Type="Folder">
		<Item Name="Controls" Type="Folder">
			<Item Name="AIT_Channel Array.ctl" Type="VI" URL="../Controls/AIT_Channel Array.ctl"/>
			<Item Name="AIT_Channel.ctl" Type="VI" URL="../Controls/AIT_Channel.ctl"/>
			<Item Name="AIT_Label.ctl" Type="VI" URL="../Controls/AIT_Label.ctl"/>
			<Item Name="AIT_Word.ctl" Type="VI" URL="../Controls/AIT_Word.ctl"/>
		...
		<Item Name="Dynamically Called" Type="Folder">
			<Item Name="Extra Pages" Type="Folder">
				<Item Name="AIT 429 ARINC Channel Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 ARINC Channel Page.vi"/>
				<Item Name="AIT 429 Inputs Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 Inputs Page.vi"/>
				<Item Name="AIT 429 Label Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 Label Page.vi"/>
				<Item Name="AIT 429 Outputs Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 Outputs Page.vi"/>
				<Item Name="AIT 429 Parameter Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 Parameter Page.vi"/>
			...
			<Item Name="AIT 429 - Add Data Channel.vi" Type="VI" URL="../Dynamically Called/AIT 429 - Add Data Channel.vi"/>
			...
			<Item Name="AIT 429 Main Page.vi" Type="VI" URL="../Dynamically Called/Pages/AIT 429 Main Page.vi"/>
		...
		<Item Name="SubVIs" Type="Folder">
			<Item Name="Owl429 SP" Type="Folder">
				<Item Name="Owl429_TxAcyclicTransferConfig_getLabel.vi" Type="VI" URL="../SubVIs/Owl429 SP/Owl429_TxAcyclicTransferConfig_getLabel.vi"/>
				<Item Name="Owl429_TxAcyclicTransferConfig_getName.vi" Type="VI" URL="../SubVIs/Owl429 SP/Owl429_TxAcyclicTransferConfig_getName.vi"/>
				<Item Name="Owl429_TxAcyclicTransferConfig_getSdi.vi" Type="VI" URL="../SubVIs/Owl429 SP/Owl429_TxAcyclicTransferConfig_getSdi.vi"/>
				<Item Name="Owl429_TxAcyclicTransferConfig_isSdiEnabled.vi" Type="VI" URL="../SubVIs/Owl429 SP/Owl429_TxAcyclicTransferConfig_isSdiEnabled.vi"/>
			</Item>
			<Item Name="Parse DB" Type="Folder">
				<Item Name="Create Label Name.vi" Type="VI" URL="../SubVIs/Parse DB/Create Label Name.vi"/>
				<Item Name="FindChannelParams.vi" Type="VI" URL="../SubVIs/Parse DB/FindChannelParams.vi"/>
				<Item Name="FindLabelParams.vi" Type="VI" URL="../SubVIs/Parse DB/FindLabelParams.vi"/>
				<Item Name="GetStringIndex.vi" Type="VI" URL="../SubVIs/Parse DB/GetStringIndex.vi"/>
				<Item Name="Iterate On DB Channels.vi" Type="VI" URL="../SubVIs/Parse DB/Iterate On DB Channels.vi"/>
				<Item Name="Parse DB Channel.vi" Type="VI" URL="../SubVIs/Parse DB/Parse DB Channel.vi"/>
				<Item Name="Parse DB RX Labels.vi" Type="VI" URL="../SubVIs/Parse DB/Parse DB RX Labels.vi"/>
				<Item Name="Parse DB TX Labels.vi" Type="VI" URL="../SubVIs/Parse DB/Parse DB TX Labels.vi"/>
				<Item Name="Parse DB.vi" Type="VI" URL="../SubVIs/Parse DB/Parse DB.vi"/>
				<Item Name="ParseXMLComment4Params.vi" Type="VI" URL="../SubVIs/Parse DB/ParseXMLComment4Params.vi"/>
				<Item Name="Query RX labels for Params.vi" Type="VI" URL="../SubVIs/Parse DB/Query RX labels for Params.vi"/>
				<Item Name="Query TX labels for Params.vi" Type="VI" URL="../SubVIs/Parse DB/Query TX labels for Params.vi"/>
				<Item Name="Query XML For Params.vi" Type="VI" URL="../SubVIs/Parse DB/Query XML For Params.vi"/>
				<Item Name="UpdateChannelWithParams.vi" Type="VI" URL="../SubVIs/Parse DB/UpdateChannelWithParams.vi"/>
			</Item>
			<Item Name="Parse XML" Type="Folder">
				<Item Name="Board" Type="Folder">
					<Item Name="XML429_Board_GetBoardConfig.vi" Type="VI" URL="../SubVIs/Parse XML/Board/XML429_Board_GetBoardConfig.vi"/>
				</Item>
				<Item Name="Channel" Type="Folder">
					<Item Name="XML429_Channel_GetChannelDirection.vi" Type="VI" URL="../SubVIs/Parse XML/Channel/XML429_Channel_GetChannelDirection.vi"/>
					<Item Name="XML429_Channel_GetChannelNumber.vi" Type="VI" URL="../SubVIs/Parse XML/Channel/XML429_Channel_GetChannelNumber.vi"/>
					<Item Name="XML429_Channel_GetChannels.vi" Type="VI" URL="../SubVIs/Parse XML/Channel/XML429_Channel_GetChannels.vi"/>
				</Item>
				<Item Name="Database" Type="Folder">
					<Item Name="XML429_Database_CloseRefnum.vi" Type="VI" URL="../SubVIs/Parse XML/Database/XML429_Database_CloseRefnum.vi"/>
					<Item Name="XML429_Database_CloseRefnumArray.vi" Type="VI" URL="../SubVIs/Parse XML/Database/XML429_Database_CloseRefnumArray.vi"/>
					<Item Name="XML429_Database_LoadConfig.vi" Type="VI" URL="../SubVIs/Parse XML/Database/XML429_Database_LoadConfig.vi"/>
				</Item>
			</Item>
			<Item Name="Refresh DB" Type="Folder">
				<Item Name="Force Rename Item.vi" Type="VI" URL="../SubVIs/Refresh DB/Force Rename Item.vi"/>
				<Item Name="NI VeriStand - Visually Update the System Explorer Tree.vi" Type="VI" URL="../SubVIs/Refresh DB/NI VeriStand - Visually Update the System Explorer Tree.vi"/>
				<Item Name="Refresh Database Import.vi" Type="VI" URL="../SubVIs/Refresh DB/Refresh Database Import.vi"/>
				<Item Name="Refresh Default Value.vi" Type="VI" URL="../SubVIs/Refresh DB/Refresh Default Value.vi"/>
